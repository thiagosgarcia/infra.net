...
public class PollyController : ControllerBase
{
    ...
    public PollyController(IHttpClientManager clientManager, IConfiguration configuration, Serilog.ILogger logger)
    {
    ...
    public async Task<IEnumerable<Entity>> Error()
    {
        ...
        var policyWrap = Policy.WrapAsync(timeoutPolicy, breaker);
    ...
    public async Task<IEnumerable<Entity>> ErrorHttpClientManagerCustomWrapper()
    {
        ...
        var policyWrap = Policy.WrapAsync(retryPolicy, authPolicy, breaker);
