...
namespace Infra.Net.CacheManager.Memcached
{
    ...
    public class CachedOperationAttribute : TypeFilterAttribute
    {
        ...
        {
            private readonly IBinaryCacheManager _cacheManager;
            private readonly string _cacheId;
            private readonly int _expireTimeMinutes;
            private readonly int _idleTimeMinutes;

            public CachedOperationImpl(IBinaryCacheManager cacheManager, string cacheId, int expireTimeMinutes, int idleTimeMinutes)
            {
